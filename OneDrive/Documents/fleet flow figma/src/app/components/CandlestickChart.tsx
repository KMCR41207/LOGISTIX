...
export function CandlestickChart({
  ...
  const handleChartTypeChange = (newType: "candlestick" | "area" | "line") => {
        ...
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              ...
              {showChartMenu && (
                <div className="fixed inset-0 z-50" onClick={() => setShowChartMenu(false)}>
                  <div 
                    className="absolute right-6 top-20 w-48 bg-slate-800 border border-slate-600 rounded-lg shadow-xl"
